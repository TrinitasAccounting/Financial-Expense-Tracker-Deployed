                ...
                <main className="px-4 py-16 sm:px-6 lg:flex-auto lg:px-0 lg:py-20">
                    <div className="mx-auto max-w-2xl space-y-16 sm:space-y-20 lg:mx-0 lg:max-w-none">
                        ...
                        <div>
                            ...
                            <button type="button" className="text-sm pt-6 font-semibold leading-6 text-indigo-600 hover:text-indigo-500">
                                <span aria-hidden="true">+</span> Add another bank
                            </button>
                        </div>

                        {/* <div>
                            <h2 className="text-2xl font-semibold leading-1 text-gray-900">Integrations</h2>
